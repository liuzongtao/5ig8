...
public class EmailTest {
	...
	public EmailTest(MimeMessage mimeMessage) {
...
//		}
	...
	public static void main(String args[]) throws Exception {
		String host = "pop3.163.com"; // 【pop.mail.yahoo.com.cn】   pop3.163.com imap.qq.com
		String username = "***@163.com";
		String password = "****";
		Properties props = new Properties();
		Session session = Session.getDefaultInstance(props, null);
		Store store = session.getStore("pop3");//imap  | pop3
		...
		for (int i = 0; i < message.length; i++) {
			pmm = new EmailTest((MimeMessage) message[i]);
			pmm.delete();
