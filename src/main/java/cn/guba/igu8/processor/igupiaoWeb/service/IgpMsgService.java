...
public class IgpMsgService {
     ...
     * @return
     */
    public Map<Boolean, Set<String>> getVipEmails(long concernedTeacherId, String kind, String vipGroup) {
    ...
    public void sendMsg(long teacherId, IgpWebMsgBean msg, boolean sendSms) {
        ...
        if (isSendEmail) {
            Map<Boolean, Set<String>> emailMap = getVipEmails(teacherId, msg.getKind(), msg.getVip_group_info());
            if (emailMap.size() > 0) {
